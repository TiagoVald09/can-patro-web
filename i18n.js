...
var TRANSLATIONS = {
          es: {
            ...
            "nav.back": "Volver a la finca",
            "booking.eyebrow": "Disponibilidad Oficial",
            "booking.title": "Reservar Estancia",
            "booking.lead": "Seleccione sus fechas de llegada y salida para consultar disponibilidad en tiempo real.",
            ...
            "intro.stat1.unit": "m²",
            "intro.stat1.desc": "Superficie villa",
            "intro.stat2.unit": "hab",
            "intro.stat2.desc": "Dormitorios",
            "intro.stat3.unit": "baños",
            "intro.stat3.desc": "Baños en suite",
            "intro.stat4.unit": "calma",
            "intro.stat4.desc": "Piscina y campo",
            ...
            "stays.casa.tag": "Exclusividad total",
            "stays.casa.feat1": "650 m² de villa",
            "stays.casa.feat2": "8 habitaciones",
            "stays.casa.feat3": "8 baños",
            "stays.casa.feat4": "Uso exclusivo",
            "stays.habitaciones.tag": "Escapadas y parejas",
            "stays.habitaciones.feat1": "Baño privado en suite",
            "stays.habitaciones.feat2": "Acceso a piscina",
            "stays.habitaciones.feat3": "WiFi alta velocidad",
            "stays.habitaciones.feat4": "Zonas comunes",
            "stays.miniapt.tag": "Autonomía y calma",
            "stays.miniapt.feat1": "Cocina equipada",
            "stays.miniapt.feat2": "Entrada independiente",
            "stays.miniapt.feat3": "Terraza / vistas",
            "stays.miniapt.feat4": "Acceso a piscina",
            ...
            "amenities.parking": "Parking privado gratis",
            "amenities.ac": "Aire acondicionado",
            "amenities.fireplaces": "Calefacción y 2 chimeneas",
            ...
            "contact.direct": "Atención directa",
            "contact.box.title": "Reservar Estancia",
    "contact.box.desc": "Compruebe fechas libres en tiempo real y reserve con trato directo y confirmación oficial.",
    "form.consent": "He leído y acepto el tratamiento de mis datos según la",
          ...
          en: {
            ...
            "nav.back": "Back to the estate",
    "booking.eyebrow": "Official Availability",
    "booking.title": "Book Your Stay",
    "booking.lead": "Select your check-in and check-out dates to check real-time availability.",
            "hero.eyebrow": "Manacor · Mallorca",
            ...
            "intro.stat1.unit": "m²",
            "intro.stat1.desc": "Villa size",
            "intro.stat2.unit": "bdrm",
            "intro.stat2.desc": "Bedrooms",
            "intro.stat3.unit": "baths",
            "intro.stat3.desc": "En-suite bathrooms",
            "intro.stat4.unit": "calm",
            "intro.stat4.desc": "Pool & countryside",
            ...
            "stays.casa.tag": "Total exclusivity",
            "stays.casa.feat1": "650 m² villa",
            "stays.casa.feat2": "8 bedrooms",
            "stays.casa.feat3": "8 bathrooms",
            "stays.casa.feat4": "Exclusive use",
            "stays.habitaciones.tag": "Getaways & couples",
            "stays.habitaciones.feat1": "Private en-suite bathroom",
            "stays.habitaciones.feat2": "Pool access",
            "stays.habitaciones.feat3": "High-speed WiFi",
            "stays.habitaciones.feat4": "Shared areas",
            "stays.miniapt.tag": "Independence & calm",
            "stays.miniapt.feat1": "Equipped kitchen",
            "stays.miniapt.feat2": "Private entrance",
            "stays.miniapt.feat3": "Terrace / views",
            "stays.miniapt.feat4": "Pool access",
            ...
            "amenities.parking": "Free private parking",
            "amenities.ac": "Air conditioning",
            "amenities.fireplaces": "Central heating & 2 fireplaces",
    ...
    "contact.box.title": "Book Your Stay",
    "contact.box.desc": "Check real-time availability and book directly with official confirmation.",
    "form.consent": "I have read and accept the processing of my data according to the",
          ...
          de: {
            ...
            "nav.back": "Zurück zum Anwesen",
    "booking.eyebrow": "Offizielle Verfügbarkeit",
    "booking.title": "Aufenthalt buchen",
    "booking.lead": "Wählen Sie Ihre Anreise- und Abreisedaten, um die Verfügbarkeit in Echtzeit zu prüfen.",
            "hero.eyebrow": "Manacor · Mallorca",
            ...
            "intro.stat1.unit": "m²",
            "intro.stat1.desc": "Wohnfläche",
            "intro.stat2.unit": "Zi.",
            "intro.stat2.desc": "Schlafzimmer",
            "intro.stat3.unit": "Bäder",
            "intro.stat3.desc": "Bäder en-suite",
            "intro.stat4.unit": "Ruhe",
            "intro.stat4.desc": "Pool & Landschaft",
            ...
            "stays.casa.tag": "Volle Exklusivität",
            "stays.casa.feat1": "650 m² Villa",
            "stays.casa.feat2": "8 Schlafzimmer",
            "stays.casa.feat3": "8 Badezimmer",
            "stays.casa.feat4": "Exklusive Nutzung",
            "stays.habitaciones.tag": "Kurzurlaub & Paare",
            "stays.habitaciones.feat1": "Eigenes Bad (en-suite)",
            "stays.habitaciones.feat2": "Poolzugang",
            "stays.habitaciones.feat3": "Highspeed-WLAN",
            "stays.habitaciones.feat4": "Gemeinschaftsbereiche",
            "stays.miniapt.tag": "Unabhängigkeit & Ruhe",
            "stays.miniapt.feat1": "Ausgestattete Küche",
            "stays.miniapt.feat2": "Eigener Eingang",
            "stays.miniapt.feat3": "Terrasse / Aussicht",
            "stays.miniapt.feat4": "Poolzugang",
        ...
        "amenities.pool": "Freiluftpool",
            ...
            "amenities.parking": "Kostenloser Privatparkplatz",
            "amenities.ac": "Klimaanlage",
            "amenities.fireplaces": "Zentralheizung & 2 Kamine",
    ...
    "contact.box.title": "Aufenthalt buchen",
    "contact.box.desc": "Prüfen Sie freie Termine in Echtzeit und buchen Sie direkt mit offizieller Bestätigung.",
    "form.consent": "Ich habe die Datenverarbeitung gelesen und akzeptiere die",
